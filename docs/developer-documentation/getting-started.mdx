...
<TabItem value="github" label="GitHub registry" default>
...
<TabItem value="npm" label="npm registry">

No additional setup is needed. RADFish packages are publicly available on the npm registry.
