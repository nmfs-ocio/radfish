...
To learn more about the Table component, see the [RADFish Table documentation](https://nmfs-ocio.github.io/radfish/design-system/custom-components/table).
...
3. **Test offline functionality**:
   ...
   ![Offline Confirmation](./src/assets/lesson-6_step-4.3-offline-confirm.png)
   
   7. Click the **Home** button to return to the homepage
   8. You should now see your trip with status "READY TO SUBMIT":
   
   ![Ready to Submit Status](./src/assets/lesson-6_step-4.3-ready-to-submit.png)
